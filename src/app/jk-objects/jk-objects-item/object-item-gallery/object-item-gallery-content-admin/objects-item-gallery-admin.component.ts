...
import { ObjectsItemGalleryAdminService } from './objects-item-gallery-admin.service';
...
@Component({
    ...
    templateUrl: './objects-item-gallery-admin.component.html',
    styleUrls: ['../../jk-objects-item.component.scss',
                './objects-item-gallery-admin.component.scss']
})
export class ObjectsItemGalleryAdminComponent implements OnInit {
