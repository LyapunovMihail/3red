...
import { ObjectsItemGalleryAdminUpload } from './objects-item-gallery-admin.upload';
...
export class ObjectsItemGalleryAdminService {
    ...
    public imageUpload(e) {
        return new Promise((resolve, reject) => {
            ...
            const myUploadItem = new ObjectsItemGalleryAdminUpload(uploadFile);
