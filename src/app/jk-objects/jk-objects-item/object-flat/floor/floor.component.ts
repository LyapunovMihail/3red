    ...
    public routerChange() {
        ...
        .subscribe((params: any) => {
            ...
            if (this.floorCount[params.house] && this.floorCount[params.house][params.section]
                ...
                this.getFloorSvg(`/assets/floor-plans/jk_${this.jk.mod}/house_${this.houseNumber}/section_${this.sectionNumber}/floor_${this.floorNumber}/sect_${this.sectionNumber}_fl_${this.floorNumber}.svg`)  // добавить дом
                .subscribe(
                    (data: string) => {
                        this.floorSvg = data;
