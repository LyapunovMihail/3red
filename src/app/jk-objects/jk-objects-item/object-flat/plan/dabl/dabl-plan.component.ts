...
import { PLAN_SVG, IHousePlanItem } from './dabl-plan-svg';
import { DablPlanService } from './dabl-plan.service';
...
@Component({
    selector: 'app-flats-dabl-plan-page',
    templateUrl: './dabl-plan.component.html',
...
export class DablPlanComponent implements OnInit {
    @Input()
    ...
    constructor(
        ...
        private planService: DablPlanService,
