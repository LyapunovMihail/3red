...
import { ObjectsItemPreviewAdminService } from './objects-item-preview-admin.service';
...
@Component({
    ...
    templateUrl: './objects-item-preview-admin.component.html',
    styleUrls: ['../../jk-objects-item.component.scss',
                './objects-item-preview-admin.component.scss']
})
export class ObjectsItemPreviewAdminComponent implements OnInit {
