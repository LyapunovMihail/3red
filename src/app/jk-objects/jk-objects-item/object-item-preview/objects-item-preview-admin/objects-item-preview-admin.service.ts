...
import { ObjectsItemPreviewAdminUpload } from './objects-item-preview-admin.upload';
...
export class ObjectsItemPreviewAdminService {
    ...
    public imageUpload(e) {
        return new Promise((resolve, reject) => {
            ...
            const myUploadItem = new ObjectsItemPreviewAdminUpload(uploadFile);
