...
import { ObjectsItemProjectAdminService } from './objects-item-project-admin.service';
import { IObjectProjectSnippet } from '../../../../../../serv-files/serv-modules/jk-objects/project-api/objects-project.interfaces';
import { INDICATORS } from '../../object-item-preview/objects-item-preview-admin/indicators';

@Component({
    selector: 'app-objects-item-project-admin',
    templateUrl: './objects-item-project-admin.component.html',
    styleUrls: ['../../jk-objects-item.component.scss',
                './objects-item-project-admin.component.scss']
})
export class ObjectsItemProjectAdminComponent implements OnInit {
