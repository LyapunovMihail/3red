...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "dcca12d75128ab12c743";
...
/***/ "./serv-modules/service/service-api/service.controller.ts":
/*!****************************************************************!*\
  !*** ./serv-modules/service/service-api/service.controller.ts ***!
  \****************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nvar __metadata = (this && this.__metadata) || function (k, v) {\n    if (typeof Reflect === \"object\" && typeof Reflect.metadata === \"function\") return Reflect.metadata(k, v);\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst response_handler_utilits_1 = __webpack_require__(/*! ../../utilits/response-handler.utilits */ \"./serv-modules/utilits/response-handler.utilits.ts\");\nconst service_model_1 = __webpack_require__(/*! ./service.model */ \"./serv-modules/service/service-api/service.model.ts\");\nconst express = __webpack_require__(/*! express */ \"express\");\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst mongo_connection_service_1 = __webpack_require__(/*! ../../mongo-connection.service */ \"./serv-modules/mongo-connection.service.ts\");\nconst express_app_service_1 = __webpack_require__(/*! ../../express-app.service */ \"./serv-modules/express-app.service.ts\");\nlet ServiceController = class ServiceController extends service_model_1.ServiceModel {\n    constructor(mongoConnectionService, expressAppService) {\n        super(mongoConnectionService.getDb().connection.db);\n        this.mongoConnectionService = mongoConnectionService;\n        this.expressAppService = expressAppService;\n        this.router = express.Router();\n        this.routing();\n    }\n    routing() {\n        this.router.get('/service/tab/:tab', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getSnippet(req.params.tab);\n        })));\n        this.router.post('/admin/service/create-update', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.updateSnippet(req.body);\n        })));\n        const app = this.expressAppService.getApp();\n        app.use('/api', this.router);\n    }\n};\nServiceController = __decorate([\n    common_1.Controller('/api'),\n    __metadata(\"design:paramtypes\", [mongo_connection_service_1.MongoConnectionService,\n        express_app_service_1.ExpressAppService])\n], ServiceController);\nexports.ServiceController = ServiceController;\n\n\n//# sourceURL=webpack:///./serv-modules/service/service-api/service.controller.ts?");

/***/ }),

/***/ "./serv-modules/service/service-api/service.interfaces.ts":
/*!****************************************************************!*\
  !*** ./serv-modules/service/service-api/service.interfaces.ts ***!
  \****************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.SERVICE_COLLECTION_NAME = 'service';\nexports.ErrorNotCorrectArguments = 'Параметры переданы не корректно.';\n\n\n//# sourceURL=webpack:///./serv-modules/service/service-api/service.interfaces.ts?");

/***/ }),

/***/ "./serv-modules/service/service-api/service.model.ts":
/*!***********************************************************!*\
  !*** ./serv-modules/service/service-api/service.model.ts ***!
  \***********************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst service_interfaces_1 = __webpack_require__(/*! ./service.interfaces */ \"./serv-modules/service/service-api/service.interfaces.ts\");\nconst ObjectId = __webpack_require__(/*! mongodb */ \"mongodb\").ObjectID;\nclass ServiceModel {\n    constructor(db) {\n        this.db = db;\n        this.collectionName = service_interfaces_1.SERVICE_COLLECTION_NAME;\n        this.collection = db.collection(this.collectionName);\n    }\n    getSnippet(tab) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const findCriteria = {};\n            const result = yield this.collection.findOne(findCriteria);\n            if (result && result.uk && tab && tab !== 'null') {\n                result.uk = result.uk.filter((slide) => slide.tab === tab);\n            }\n            return result;\n        });\n    }\n    updateSnippet(parameters) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const options = parameters;\n            return yield this.errorParamsCatcher(this.valuesReview(options), () => __awaiter(this, void 0, void 0, function* () {\n                if ('_id' in options) {\n                    delete options._id;\n                }\n                yield this.collection.update({}, { $set: options }, { upsert: true });\n            }));\n        });\n    }\n    deleteSnippet(objectId) {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.deleteOne({ objectId });\n        });\n    }\n    errorParamsCatcher(val, fn) {\n        return __awaiter(this, void 0, void 0, function* () {\n            if (val) {\n                yield fn();\n                return yield this.getSnippet();\n            }\n            else {\n                throw new Error(service_interfaces_1.ErrorNotCorrectArguments);\n            }\n        });\n    }\n    valuesReview(options) {\n        return 'created_at' in options && 'last_modifyed' in options && 'uk' in options;\n    }\n}\nexports.ServiceModel = ServiceModel;\n\n\n//# sourceURL=webpack:///./serv-modules/service/service-api/service.model.ts?");

/***/ }),

/***/ "./serv-modules/service/service-controllers.ts":
/*!*****************************************************!*\
  !*** ./serv-modules/service/service-controllers.ts ***!
  \*****************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst service_tabs_controller_1 = __webpack_require__(/*! ./tabs-api/service-tabs.controller */ \"./serv-modules/service/tabs-api/service-tabs.controller.ts\");\nconst service_controller_1 = __webpack_require__(/*! ./service-api/service.controller */ \"./serv-modules/service/service-api/service.controller.ts\");\nexports.serviceControllers = [\n    service_tabs_controller_1.ServiceTabsController,\n    service_controller_1.ServiceController\n];\n\n\n//# sourceURL=webpack:///./serv-modules/service/service-controllers.ts?");

/***/ }),

/***/ "./serv-modules/service/tabs-api/service-tabs.controller.ts":
/*!******************************************************************!*\
  !*** ./serv-modules/service/tabs-api/service-tabs.controller.ts ***!
  \******************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nvar __metadata = (this && this.__metadata) || function (k, v) {\n    if (typeof Reflect === \"object\" && typeof Reflect.metadata === \"function\") return Reflect.metadata(k, v);\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst response_handler_utilits_1 = __webpack_require__(/*! ../../utilits/response-handler.utilits */ \"./serv-modules/utilits/response-handler.utilits.ts\");\nconst service_tabs_model_1 = __webpack_require__(/*! ./service-tabs.model */ \"./serv-modules/service/tabs-api/service-tabs.model.ts\");\nconst express = __webpack_require__(/*! express */ \"express\");\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst mongo_connection_service_1 = __webpack_require__(/*! ../../mongo-connection.service */ \"./serv-modules/mongo-connection.service.ts\");\nconst express_app_service_1 = __webpack_require__(/*! ../../express-app.service */ \"./serv-modules/express-app.service.ts\");\nlet ServiceTabsController = class ServiceTabsController extends service_tabs_model_1.ServiceTabsModel {\n    constructor(mongoConnectionService, expressAppService) {\n        super(mongoConnectionService.getDb().connection.db);\n        this.mongoConnectionService = mongoConnectionService;\n        this.expressAppService = expressAppService;\n        this.router = express.Router();\n        this.routing();\n    }\n    routing() {\n        this.router.get('/service/tabs', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getTeamTabs();\n        })));\n        this.router.post('/admin/service/tabs/create-update', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.updateTeamTabs(req.body);\n        })));\n        const app = this.expressAppService.getApp();\n        app.use('/api', this.router);\n    }\n};\nServiceTabsController = __decorate([\n    common_1.Controller('/api'),\n    __metadata(\"design:paramtypes\", [mongo_connection_service_1.MongoConnectionService,\n        express_app_service_1.ExpressAppService])\n], ServiceTabsController);\nexports.ServiceTabsController = ServiceTabsController;\n\n\n//# sourceURL=webpack:///./serv-modules/service/tabs-api/service-tabs.controller.ts?");

/***/ }),

/***/ "./serv-modules/service/tabs-api/service-tabs.interfaces.ts":
/*!******************************************************************!*\
  !*** ./serv-modules/service/tabs-api/service-tabs.interfaces.ts ***!
  \******************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.SERVICE_TABS_COLLECTION_NAME = 'ServiceTabs';\nexports.ErrorNotCorrectArguments = 'Параметры переданы не корректно.';\n\n\n//# sourceURL=webpack:///./serv-modules/service/tabs-api/service-tabs.interfaces.ts?");

/***/ }),

/***/ "./serv-modules/service/tabs-api/service-tabs.model.ts":
/*!*************************************************************!*\
  !*** ./serv-modules/service/tabs-api/service-tabs.model.ts ***!
  \*************************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst service_tabs_interfaces_1 = __webpack_require__(/*! ./service-tabs.interfaces */ \"./serv-modules/service/tabs-api/service-tabs.interfaces.ts\");\nconst service_interfaces_1 = __webpack_require__(/*! ../service-api/service.interfaces */ \"./serv-modules/service/service-api/service.interfaces.ts\");\nconst ObjectId = __webpack_require__(/*! mongodb */ \"mongodb\").ObjectID;\nclass ServiceTabsModel {\n    constructor(db) {\n        this.db = db;\n        this.collectionName = service_tabs_interfaces_1.SERVICE_TABS_COLLECTION_NAME;\n        this.serviceCollectionName = service_interfaces_1.SERVICE_COLLECTION_NAME;\n        this.collection = db.collection(this.collectionName);\n        this.serviceCollection = db.collection(this.serviceCollectionName);\n    }\n    getTeamTabs() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.findOne({});\n        });\n    }\n    updateTeamTabs(parameters) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const options = parameters;\n            return yield this.errorParamsCatcher(this.valuesReview(options), () => __awaiter(this, void 0, void 0, function* () {\n                if ('_id' in options) {\n                    delete options._id;\n                }\n                this.deleteUk(options);\n                yield this.collection.update({}, { $set: options }, { upsert: true });\n            }));\n        });\n    }\n    deleteUk(options) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const tabs = options.tabs.map((item) => item.name);\n            yield this.serviceCollection.remove({ $pull: { uk: { tab: { $nin: tabs } } } });\n        });\n    }\n    deleteSnippet() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.deleteOne({});\n        });\n    }\n    errorParamsCatcher(val, fn) {\n        return __awaiter(this, void 0, void 0, function* () {\n            if (val) {\n                yield fn();\n                return yield this.getTeamTabs();\n            }\n            else {\n                throw new Error(service_tabs_interfaces_1.ErrorNotCorrectArguments);\n            }\n        });\n    }\n    valuesReview(options) {\n        return 'tab' in options;\n    }\n}\nexports.ServiceTabsModel = ServiceTabsModel;\n\n\n//# sourceURL=webpack:///./serv-modules/service/tabs-api/service-tabs.model.ts?");
