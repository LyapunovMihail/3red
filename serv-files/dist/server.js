...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "d250a7bdd7f710663c1d";
...
/***/ "./serv-modules/credit-api/credit.controller.ts":
/*!******************************************************!*\
  !*** ./serv-modules/credit-api/credit.controller.ts ***!
  \******************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nvar __metadata = (this && this.__metadata) || function (k, v) {\n    if (typeof Reflect === \"object\" && typeof Reflect.metadata === \"function\") return Reflect.metadata(k, v);\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst response_handler_utilits_1 = __webpack_require__(/*! ./../utilits/response-handler.utilits */ \"./serv-modules/utilits/response-handler.utilits.ts\");\nconst credit_model_1 = __webpack_require__(/*! ./credit.model */ \"./serv-modules/credit-api/credit.model.ts\");\nconst express = __webpack_require__(/*! express */ \"express\");\nconst multipart = __webpack_require__(/*! connect-multiparty */ \"connect-multiparty\");\nconst mongo_connection_service_1 = __webpack_require__(/*! ../mongo-connection.service */ \"./serv-modules/mongo-connection.service.ts\");\nconst express_app_service_1 = __webpack_require__(/*! ../express-app.service */ \"./serv-modules/express-app.service.ts\");\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nlet CreditController = class CreditController extends credit_model_1.CreditModel {\n    constructor(mongoConnectionService, expressAppService) {\n        super(mongoConnectionService.getDb().connection.db);\n        this.mongoConnectionService = mongoConnectionService;\n        this.expressAppService = expressAppService;\n        this.router = express.Router();\n        this.routing();\n    }\n    routing() {\n        this.router.get('/credit/all', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getAllSnippet();\n        })));\n        this.router.get('/credit/active', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getActiveSnippet();\n        })));\n        this.router.post('/credit/active_with_params', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getActiveSnippetWithParams(req.body.params);\n        })));\n        this.router.post('/admin/credit/create', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.setSnippet(req.body.banks);\n        })));\n        this.router.post('/admin/credit/delete', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.deleteSnippet(req.body.id);\n        })));\n        this.router.post('/admin/credit/update', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.updateSnippet(req.body.id, req.body.key, req.body.value);\n        })));\n        const multipartMiddleware = multipart();\n        this.router.post('/admin/credit/image', multipartMiddleware, response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.uploadSnippetImage(req);\n        })));\n        const app = this.expressAppService.getApp();\n        app.use('/api', this.router);\n    }\n};\nCreditController = __decorate([\n    common_1.Controller('/api'),\n    __metadata(\"design:paramtypes\", [mongo_connection_service_1.MongoConnectionService,\n        express_app_service_1.ExpressAppService])\n], CreditController);\nexports.CreditController = CreditController;\n\n\n//# sourceURL=webpack:///./serv-modules/credit-api/credit.controller.ts?");

/***/ }),

/***/ "./serv-modules/credit-api/credit.interfaces.ts":
/*!******************************************************!*\
  !*** ./serv-modules/credit-api/credit.interfaces.ts ***!
  \******************************************************/
/*! no static exports found */
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.CREDIT_COLLECTION_NAME = 'credit';\nexports.CREDIT_UPLOADS_PATH = 'uploads/credit/';\n\n\n//# sourceURL=webpack:///./serv-modules/credit-api/credit.interfaces.ts?");

/***/ }),

/***/ "./serv-modules/credit-api/credit.model.ts":
/*!*************************************************!*\
  !*** ./serv-modules/credit-api/credit.model.ts ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst image_saver_utilits_1 = __webpack_require__(/*! ./../utilits/image-saver.utilits */ \"./serv-modules/utilits/image-saver.utilits.ts\");\nconst credit_interfaces_1 = __webpack_require__(/*! ./credit.interfaces */ \"./serv-modules/credit-api/credit.interfaces.ts\");\nconst dateFormat = __webpack_require__(/*! dateformat */ \"dateformat\");\nconst ObjectId = __webpack_require__(/*! mongodb */ \"mongodb\").ObjectID;\nclass CreditModel {\n    constructor(db) {\n        this.db = db;\n        this.collectionName = credit_interfaces_1.CREDIT_COLLECTION_NAME;\n        this.collection = db.collection(this.collectionName);\n    }\n    getAllSnippet() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.find().sort({ created_at: -1 }).toArray();\n        });\n    }\n    getActiveSnippet() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.find({ active: true }).sort({ created_at: -1 }).toArray();\n        });\n    }\n    getActiveSnippetWithParams(params) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const snippets = yield this.collection.find({\n                active: true,\n                initial: { $lte: params.initial },\n                deadline: { $gte: params.deadline },\n            })\n                .sort({ created_at: -1 }).toArray();\n            return snippets;\n        });\n    }\n    setSnippet(banks) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const date = new Date();\n            yield this.collection.remove({});\n            const banksSnippets = [];\n            banks.forEach((bank) => {\n                const created_at = dateFormat(date, 'yyyy-mm-ddTHH:MM:ssZ');\n                const snippet = {\n                    name: bank.name,\n                    image: bank.image,\n                    cssclass: bank.cssclass,\n                    percent: 0,\n                    initial: 0,\n                    deadline: 0,\n                    active: true,\n                    created_at,\n                };\n                banksSnippets.push(snippet);\n            });\n            yield this.collection.insertMany(banksSnippets);\n            return yield this.getAllSnippet();\n        });\n    }\n    deleteSnippet(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            if (id && ObjectId.isValid(id)) {\n                yield this.collection.deleteOne({ _id: ObjectId(id) });\n                return yield this.getActiveSnippet();\n            }\n            else {\n                throw new Error('Не корректный id.');\n            }\n        });\n    }\n    updateSnippet(id, key, value) {\n        return __awaiter(this, void 0, void 0, function* () {\n            switch (key) {\n                case 'percent':\n                case 'initial':\n                case 'deadline':\n                case 'active':\n                    if (value === undefined) {\n                        throw new Error(`Не передано значение ${key}`);\n                    }\n                    if ((key === 'initial' || key === 'percent' || key === 'deadline') && typeof value !== 'number') {\n                        throw new Error(`значение ${key} не цифровые, печатайте цифры`);\n                    }\n                    if (ObjectId.isValid(id)) {\n                        const options = {};\n                        options[key] = value;\n                        yield this.collection.update({ _id: ObjectId(id) }, { $set: options });\n                        return yield this.getActiveSnippet();\n                    }\n                    else {\n                        throw new Error('Не корректный id.');\n                    }\n                default:\n                    throw new Error('Изменяемый параметр указан не корректно, или такого параметра не может быть.');\n            }\n        });\n    }\n    uploadSnippetImage(req) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const path = credit_interfaces_1.CREDIT_UPLOADS_PATH;\n            const image = yield image_saver_utilits_1.imageSaver(req, path, 50);\n            yield this.collection.update({ _id: ObjectId(req.headers.id) }, { $set: { image } });\n            return yield this.getActiveSnippet();\n        });\n    }\n}\nexports.CreditModel = CreditModel;\n\n\n//# sourceURL=webpack:///./serv-modules/credit-api/credit.model.ts?");

/***/ }),

/***/ "./serv-modules/documentation-api/documentation.controller.ts":
/*!********************************************************************!*\
  !*** ./serv-modules/documentation-api/objects-documentation.controller.ts ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("\nvar __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {\n    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;\n    if (typeof Reflect === \"object\" && typeof Reflect.decorate === \"function\") r = Reflect.decorate(decorators, target, key, desc);\n    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;\n    return c > 3 && r && Object.defineProperty(target, key, r), r;\n};\nvar __metadata = (this && this.__metadata) || function (k, v) {\n    if (typeof Reflect === \"object\" && typeof Reflect.metadata === \"function\") return Reflect.metadata(k, v);\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst response_handler_utilits_1 = __webpack_require__(/*! ./../utilits/response-handler.utilits */ \"./serv-modules/utilits/response-handler.utilits.ts\");\nconst documentation_model_1 = __webpack_require__(/*! ./documentation.model */ \"./serv-modules/documentation-api/objects-documentation.model.ts\");\nconst multipart = __webpack_require__(/*! connect-multiparty */ \"connect-multiparty\");\nconst express = __webpack_require__(/*! express */ \"express\");\nconst common_1 = __webpack_require__(/*! @nestjs/common */ \"@nestjs/common\");\nconst mongo_connection_service_1 = __webpack_require__(/*! ../mongo-connection.service */ \"./serv-modules/mongo-connection.service.ts\");\nconst express_app_service_1 = __webpack_require__(/*! ../express-app.service */ \"./serv-modules/express-app.service.ts\");\nlet DocumentaionController = class DocumentaionController extends documentation_model_1.ObjectsDocumentationModel {\n    constructor(mongoConnectionService, expressAppService) {\n        super(mongoConnectionService.getDb().connection.db);\n        this.mongoConnectionService = mongoConnectionService;\n        this.expressAppService = expressAppService;\n        this.router = express.Router();\n        this.routing();\n    }\n    routing() {\n        this.router.get('/documentation/list', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getObjects();\n        })));\n        this.router.get('/documentation/header', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.getHeaderDescription();\n        })));\n        this.router.post('/admin/documentation/header/update', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.updateHeaderDescription(req.body.description);\n        })));\n        this.router.post('/admin/documentation/create', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.createObject();\n        })));\n        this.router.post('/admin/documentation/delete', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.deleteObject(req.body.id);\n        })));\n        this.router.post('/admin/documentation/update', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.updateObjectTitle(req.body.id, req.body.title);\n        })));\n        const multipartMiddleware = multipart();\n        this.router.post('/admin/documentation/file/set', multipartMiddleware, response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.uploadFile(req);\n        })));\n        this.router.post('/admin/documentation/file/delete', response_handler_utilits_1.responseHandler((req) => __awaiter(this, void 0, void 0, function* () {\n            return yield this.deleteFile(req.body.id, req.body.file);\n        })));\n        const app = this.expressAppService.getApp();\n        app.use('/api', this.router);\n    }\n};\nDocumentaionController = __decorate([\n    common_1.Controller('/api'),\n    __metadata(\"design:paramtypes\", [mongo_connection_service_1.MongoConnectionService,\n        express_app_service_1.ExpressAppService])\n], DocumentaionController);\nexports.DocumentaionController = DocumentaionController;\n\n\n//# sourceURL=webpack:///./serv-modules/documentation-api/objects-documentation.controller.ts?");

/***/ }),

/***/ "./serv-modules/documentation-api/documentation.interfaces.ts":
/*!********************************************************************!*\
  !*** ./serv-modules/documentation-api/objects-documentation.interfaces.ts ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.DOCUMENTATION_COLLECTION_NAME = 'documentation';\n;\n\n\n//# sourceURL=webpack:///./serv-modules/documentation-api/objects-documentation.interfaces.ts?");

/***/ }),

/***/ "./serv-modules/documentation-api/documentation.model.ts":
/*!***************************************************************!*\
  !*** ./serv-modules/documentation-api/objects-documentation.model.ts ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst file_saver_utilits_1 = __webpack_require__(/*! ./../utilits/file-saver.utilits */ \"./serv-modules/utilits/file-saver.utilits.ts\");\nconst fileuploads_interfaces_1 = __webpack_require__(/*! ./../fileuploads-api/fileuploads.interfaces */ \"./serv-modules/fileuploads-api/fileuploads.interfaces.ts\");\nconst documentation_interfaces_1 = __webpack_require__(/*! ./documentation.interfaces */ \"./serv-modules/documentation-api/objects-documentation.interfaces.ts\");\nconst ObjectId = __webpack_require__(/*! mongodb */ \"mongodb\").ObjectID;\nclass ObjectsDocumentationModel {\n    constructor(db) {\n        this.db = db;\n        this.collectionName = documentation_interfaces_1.DOCUMENTATION_COLLECTION_NAME;\n        this.mainObjectId = 'header';\n        this.collection = db.collection(this.collectionName);\n    }\n    createObject() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const objItem = {\n                title: '',\n                uploads: []\n            };\n            yield this.collection.insert(objItem);\n            return yield this.getObjects();\n        });\n    }\n    getHeaderDescription() {\n        return __awaiter(this, void 0, void 0, function* () {\n            let headerDescription = yield this.collection.findOne({ _id: this.mainObjectId });\n            return (headerDescription ? headerDescription : {\n                description: ''\n            });\n        });\n    }\n    updateHeaderDescription(description) {\n        return __awaiter(this, void 0, void 0, function* () {\n            let headerDescription = yield this.collection.findOne({ _id: this.mainObjectId });\n            let options = {\n                _id: this.mainObjectId,\n                description\n            };\n            if (headerDescription) {\n                yield this.collection.updateOne({ _id: this.mainObjectId }, { $set: { description } });\n            }\n            else {\n                yield this.collection.insert(options);\n            }\n            return options;\n        });\n    }\n    getObjects() {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.collection.find({ _id: { $ne: this.mainObjectId } }).toArray();\n        });\n    }\n    deleteObject(_id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            yield this.collection.deleteOne({ _id: ObjectId(_id) });\n            return yield this.getObjects();\n        });\n    }\n    updateObjectTitle(_id, title) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const options = { title };\n            yield this.collection.updateOne({ _id: ObjectId(_id) }, { $set: options });\n            return yield this.getObjects();\n        });\n    }\n    uploadFile(req) {\n        return __awaiter(this, void 0, void 0, function* () {\n            let _id = req.headers.id;\n            let path = fileuploads_interfaces_1.FILEUPLOADS_UPLOADS_PATH;\n            let fileName = yield file_saver_utilits_1.fileSaver(req, path);\n            const date = new Date();\n            let snippet = {\n                name: fileName,\n                originalName: req.files['file'].originalFilename,\n                created_at: date\n            };\n            yield this.collection.updateOne({ _id: ObjectId(_id) }, { $push: { uploads: snippet } });\n            return yield this.getObjects();\n        });\n    }\n    deleteFile(_id, file) {\n        return __awaiter(this, void 0, void 0, function* () {\n            if (_id && file) {\n                yield this.collection.updateOne({ _id: ObjectId(_id) }, { $pull: { uploads: file } });\n            }\n            return yield this.getObjects();\n        });\n    }\n}\nexports.ObjectsDocumentationModel = ObjectsDocumentationModel;\n\n\n//# sourceURL=webpack:///./serv-modules/documentation-api/objects-documentation.model.ts?");
