import { ErrorNotCorrectArguments, HOME_INFO_COLLECTION_NAME, IHomeInfoSnippet } from './home-info.interfaces';

export class HomeInfoModel {

    collectionName = HOME_INFO_COLLECTION_NAME;
    ...
    async updateSnippet(parameters) {
        const options: IHomeInfoSnippet = parameters;
