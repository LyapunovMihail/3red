import { ObjectPurchaseInstallmentNumberPipe } from './object-item-installment.pipe';
import { ObjectPurchaseInstallmentService, FormParams } from './object-item-installment.service';
import { Component, OnInit } from '@angular/core';

@Component({
    selector: 'app-object-item-installment',
    templateUrl: 'object-item-installment.component.html',
    styleUrls: [ 'object-item-installment.component.scss' ],
    providers: [
        ObjectPurchaseInstallmentNumberPipe
    ]
})

export class ObjectItemInstallmentComponent implements OnInit {
